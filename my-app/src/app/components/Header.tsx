    ...
    <header className="flex justify-between items-center p-4 relative">          
      ...
      {user && (
        ...
        <div className={`absolute top-full right-0 w-full bg-white shadow-md z-10`}>
          <div className={`transition-all delay-150 duration-200 overflow-hidden w-full ${isMenuOpen ? "max-h-[22rem]" : "max-h-0"}`}>
            <div className="flex flex-col">
              ...
              <div className="w-full px-4 py-2 hover:bg-gray-200">
                <Link href="/event" className="block text-center" onClick={closeMenu}>Galleri</Link>
              </div>
              <div className="w-full px-4 py-2 hover:bg-gray-200">
                <Link href="/n0llan" className="block text-center" onClick={closeMenu}>nØllan</Link>
              </div>
              <div className="w-full px-4 py-2 hover:bg-gray-200">
                <Link href="/phosare" className="block text-center" onClick={closeMenu}>Phösare</Link>
              </div>
              <div className="w-full px-4 py-2 hover:bg-gray-200">
                <Link href="/blandaren" className="block text-center" onClick={closeMenu}>Bländare</Link>
              </div>
              <div className="w-full px-4 py-2 hover:bg-gray-200">
        ...
        <div className="hidden landscape:flex items-center gap-4">
          <Link href="/profil" className="text-gray-700 hover:text-blue-400 font-medium transition ease-in-out">Profil</Link>
          <Link href="/event" className="text-gray-700 hover:text-blue-400 font-medium transition ease-in-out">Galleri</Link>
          <Link href="/n0llan" className="text-gray-700 hover:text-blue-400 font-medium transition ease-in-out">nØllan</Link>
